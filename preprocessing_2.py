...
for i in range(len(operation)):
	if def_action[i] == 'Buy':
		def_action[i] = 'Hold'
	elif def_action[i] == 'Sell':
		def_action[i] = 'Hold'
	elif def_action[i] == 'Buy_def':
		def_action[i] = 'Buy'
	elif def_action[i] == 'Sell_def':
		def_action[i] = 'Sell'
...
figure_name = date_data_name_plot_2(datainizio_2, datafine_2)
plot.savefig(figure_name)
	
xlsx = date_data_name_xlsx_2(datainizio_2, datafine_2)
