...
tabella['CMF'] = transformer(tabella['CMF'])

header = tabella.columns

# indicators transformation --> select only used transformations
...
# ---- IF FEATURE SELECTION IS USED WITH SECOND PART USE THIS CONDITIONS ----
...
plot = graph(tabella)
figure_name = date_data_name_plot_fs(datainizio_2, datafine_2)
plot.savefig(figure_name)
	
xlsx = date_data_name_xlsx_fs(datainizio_2, datafine_2)
